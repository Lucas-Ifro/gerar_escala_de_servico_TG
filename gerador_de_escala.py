    ...
    for i in range(quantidade_de_dias):
        ...
        if data_da_escala.weekday() < 5:
            ...
            for comandante in range(len(df_monitores)):
                ...
                if(data_da_escala.weekday() == 1):
                    print((data_da_escala.weekday() in disponibilidade) & (ultimo_servico_preta != dia_anterior) & (ultimo_servico_vermelha != dia_anterior))
